...
For week 33 of #TidyTuesday 2022 I had to manually select names from a dataset. So, I typed something like `filter(df, name %in% c("The Witcher", "Hamilton", "Westworld", "Sense8")`.
...
![](images/drake.jpg){fig-align="center" width="300"}
